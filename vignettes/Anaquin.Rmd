...
```{r}
set.seed(1234)
sim1 <- 1.0 + 1.2*log2(RnaQuinMixtureA$MixA) + rnorm(nrow(RnaQuinMixtureA),0,1)
sim2 <- c(1.0 + rnorm(100,1,3), 1.0 +
          1.2*log2(tail(RnaQuinMixtureA,64)$MixA) +
          rnorm(64,0,1))
```
...
names <- row.names(RnaQuinMixtureA)
input <- log2(RnaQuinMixtureA$MixA)
